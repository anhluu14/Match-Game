...
function shuffleCardImageClasses() {
  ...
  const images = ["image-1", "image-1", "image-2", "image-2", "image-3", "image-3","image-4", "image-4", "image-5","image-5", "image-6", "image-6"];
   ...
   */
  let shuffledImageClasses = _.shuffle(images);
  console.log(shuffledImageClasses);
